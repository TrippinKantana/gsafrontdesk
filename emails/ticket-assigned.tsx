      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Section style={styles.header}>
            <Heading style={styles.heading}>🎫 Ticket Assigned to You</Heading>
          </Section>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.text}>
              A support ticket has been assigned to you{assignedBy && ` by ${assignedBy}`}.
            </Text>
            ...
            <Text style={styles.footer}>
              Please review and respond to this ticket as soon as possible. If you have any questions, contact
              your team lead or system administrator.
            </Text>
          </Section>
        </Container>
      </Body>
